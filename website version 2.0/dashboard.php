...
if(Session::get('role') == 'company')
{
    ...
    $param = array(Session::get('current_company'),'progress');
    ...
    $param = array('client',Session::get('current_company'));
    $client = $client->getmultipledata($query,$param);
    $client = $client->count();  

    $employee = new Data();
    $query = "SELECT username FROM users WHERE role=? AND related_company=?";
    $param = array('company',Session::get('current_company'));
    $employee = $employee->getmultipledata($query,$param);
    $employee = $employee->count();

    $complete_project = new Data();
    $query = "SELECT project_name FROM project_log WHERE company_id=?";
    $param = array(Session::get('current_company'));
    $complete_project = $complete_project->getmultipledata($query,$param);
    $complete_project = $complete_project->count();

    $ongoing_project = new Data();
    $query = "SELECT project_name FROM project WHERE company_id=?";
    $param = array(Session::get('current_company'));
    $ongoing_project = $ongoing_project->getmultipledata($query,$param);
    $ongoing_project = $ongoing_project->count();

    $total_project = $ongoing_project + $complete_project;
?>
                                    ...
                                    <table id="developer" class="table table-hover">
                                            ...
                                            <?php foreach($project as $value): ?>
                                                <tr name="<?php echo $value->ID ?>">
                                                    ...
                                                    ?>
                                                    <td class="doneCell"><?php echo (int)$submission; ?>% complete</td>
                                                    <td class="doneProject">
                                                        <a href="requirement.php?id=<?php echo $value->ID; ?>">
                                                            <button type="button" class="btn btn-sm btn-success">Details</button>
                                                        </a>
                                                    <?php if((int)$submission == 100): ?>
                                                    <a onclick='doneProject(<?php echo $value->ID; ?>)'><button type='button' class='btn btn-sm btn-dark'>Done project</button></a> 
                                                    <?php endif ?> 
                                                    </td>
                                                </tr>
                                            <?php $x++; ?>
                        ...
                        <div class="card-body">
                            <div class="stat-widget-one">
                                ...
                                <div class="stat-content dib">
                                    ...
                                    <div class="stat-digit"><?php echo $total_project; ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="stat-widget-one">
                                ...
                                <div class="stat-content dib">
                                    ...
                                    <div class="stat-digit"><?php echo $employee; ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="stat-widget-one">
                                ...
                                <div class="stat-content dib">
                                    ...
                                    <div class="stat-digit"><?php echo $client; ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
