    ...
    if ($validate->passed()){ 
        ...
        foreach($data as $d)
        {
            $user->create('notice', array(
                'to_whom' => $d->username,
                'data' => 'New client named '.Input::get('username').' is added to your project. ',
                'link' => 'http://localhost/eclient/00.final%20site/view_profile.php?username='.Input::get('username'),
                'active' => 'unread' 
            ));
        }
                            ...
                            <div class="col col-lg-12" style="margin-top:20px;"><hr>
                                <div class="col col-lg-6">
                                    <!-- Button trigger modal -->
                                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#finishmodel">
                                        Finish project
                                        </button>

                                        <!-- Modal -->
                                        <div class="modal fade" id="finishmodel" tabindex="-1" role="dialog" aria-labelledby="finishmodelTitle" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            ...
                                            <div class="modal-body">
                                                It means if you complete your project than you can take action as done project. You can't undo this action.
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                                <button onclick="doneProject(<?php echo Session::get('current_project'); ?>)" type="button" class="btn btn-success">Finish</button>
                                            </div>
                                            </div>
                                        </div>
                                        </div>
                                ...
                                <div class="col col-lg-6">
                                    <!-- Button trigger modal -->
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            ...
                                            <div class="modal-body">
                                            It means, If you delete this project then this project will never be recover. There is no any other options to recover. So think again before delete.
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                                <button onclick="deleteProject(<?php echo Session::get('current_project'); ?>)" type="button" class="btn btn-danger">Delete</button>
                                            </div>
                                            </div>
                                        </div>
                                        </div>
