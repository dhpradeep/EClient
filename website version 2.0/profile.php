    ...
    if(Input::get('change_pass'))
    {
            ...
            if($validate->passed()) {
                if(Hash::make(Input::get('current_password'),'$#@!abcd!@#$1234') !== Session::get('current_user_password')) {
                    ...
                    $user = new User();
                    $user->update('users',array(
                        //Hash::make(Input::get('new_password'),'$#@!abcd!@#$1234')
...
//     $upload->file($_FILES['profile_file']);
                            ...
                            <form action="" method="post" class="form-horizontal">
                                ...
                                <div class="col col-lg-12">
                                    <div class="has-success form-group">
                                        ...
                                        <input id="first_name" type="text" name="first_name" class="form-control-success form-control" value=<?php echo $value->fName; ?> >
                                    </div>
                                    <div class="has-success form-group">
                                        <label for="last_name" class=" form-control-label">Last name*</label>
                                        <input id="last_name" type="text" name="last_name" class="form-control-success form-control" value=<?php echo $value->lName; ?>>
                                    </div>
                                    <div class="has-success form-group">
                                        <label for="phone" class=" form-control-label">Phone</label>
                                        <input id="phone" type="text" name="phone" class="form-control-success form-control" value=<?php echo $value->phone; ?>>
                                    </div>
                                    <div class="has-success form-group">
                                        <label for="email" class=" form-control-label">Email*</label>
                                        <input id="email" type="text" name="email" class="form-control-success form-control" value=<?php echo $value->email; ?>>
                                    </div>
                                    <!-- <label for="files">Choose file</label>
                                    <div class="custom-file">
                                    <input name="profile_file" id="files" type="file" class="custom-file-input">
                                    <label for="files" class="custom-file-label text-truncate">Choose file...</label>
                                    <small id="emailHelp" class="form-text text-muted">Image should be less than 2MB.</small>
                                    </div><br><br> -->
